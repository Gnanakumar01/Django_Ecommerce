...
def send_otp_mail(request):
    ...
    if request.method == 'POST':
        ...
        if email:
            ...
            message = f"Your OTP is {otp}. It will expore in 10 minutes"
            send_mail(
                subject= subject,
                message= message,
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if otp_record.is_expired():
                context['error'] = "OTP expired. Try agian."
            else:
...
# Setting new password taking the verification email from session
...
def set_new_password(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'authentication/pwd_reset/finish.html')
    else:
